...
export const AUDIT_LOG_FIXTURES: AuditLogEntry[] = [
  {
    ...
    actorUserId: 'u1000000-0000-4000-8000-000000000020',
    eventType: 'update',
  ...
  },
  {
    ...
    recordId: 'p1000000-0000-4000-8000-000000000099',
    createdAt: '2026-05-25T09:30:00Z',
    summary: 'insert on onboarding_plans',
  },
  {
    id: 'a1000000-0000-4000-8000-000000000003',
    actorUserId: 'u1000000-0000-4000-8000-000000000001',
    eventType: 'update',
    tableName: 'task_progress',
    recordId: 't1000000-0000-4000-8000-000000000010',
